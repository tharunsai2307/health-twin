      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <ConsentCard who="Dr. Arun" data="Clinical Access" permission="Full Read" expiry="2027-08-12" status="active" />
            <ConsentCard who="City Hospital" data="Lab Reports" permission="Read & Upload" expiry="2026-12-31" status="active" />
            <ConsentCard who="Family Member" data="Medical History" permission="Emergency Only" expiry="—" status="restricted" />
            <ConsentCard who="HealthTwin AI" data="AI Analysis" permission="Authorized" expiry="—" status="active" />
          </div>
        </div>
      </section>
